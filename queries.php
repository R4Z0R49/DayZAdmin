...
switch($sql)
{
	...
	//Map	
		$map0 = array("SELECT Player_DATA.playerName as name, Player_DATA.playerUID, 
        Character_DATA.PlayerUID as unique_id, 
        ...
        $map1 = array("SELECT Player_DATA.playerName as name, Player_DATA.playerUID,
        Character_DATA.PlayerUID as unique_id,
        Character_DATA.CharacterID as cid,
        Character_DATA.Worldspace as worldspace,
        Character_DATA.Model as model,
        ...
        where Player_DATA.PlayerUID = Character_DATA.PlayerUID
        and Character_DATA.Alive = 1");
        $map2 = array("SELECT Player_DATA.playerName as name, Player_DATA.playerUID,
        Character_DATA.PlayerUID as unique_id,
        Character_DATA.CharacterID as cid,
        Character_DATA.Worldspace as worldspace,
        Character_DATA.Model as model,
