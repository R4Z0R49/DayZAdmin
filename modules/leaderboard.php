...
<div class="leaderboard-box">	
	...
	<select class="form-control pull-right" style="width:150px; margin-top: 20px; margin-bottom: 20px;" onChange='window.location="index.php?leaderboard<?php if(isset($_GET['limit'])) { echo '&limit=' . $_GET['limit']; } ?><?php if(isset($_GET['value'])) { echo '&value=' . $_GET['value']; } ?>&sorttype=" + this.value;'>
